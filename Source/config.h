...
#define PRIOR ap_ufixed<8, -4, AP_RND, AP_SAT>
#define MEANS ap_fixed<8, 0, AP_RND, AP_SAT>
#define VARS ap_fixed<8, 10, AP_RND, AP_SAT>
#define PROB ap_ufixed<16, 0, AP_RND, AP_SAT>
#define RESP ap_ufixed<16, 12, AP_RND, AP_SAT>
...
const uint32_t  DATA_NUM = 561000;
